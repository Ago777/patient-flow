                    ...
                    <div className="scroll">
                        <PerfectScrollbar option={{suppressScrollX: true, wheelPropagation: false}}>
                            <Nav vertical className="list-unstyled">
                                ...
                                <NavItem
                                    className={classnames({
                                        active: ((this.state.selectedParentMenu == "reviews" && this.state.viewingParentMenu == "") || this.state.viewingParentMenu == "reviews")
                                    })}
                                >
                                    <NavLink
                                        to="/app/ui"
                                ...
                                <NavItem
                                    className={classnames({
                                        active: ((this.state.selectedParentMenu == "SEO" && this.state.viewingParentMenu == "") || this.state.viewingParentMenu == "SEO")
                                    })}
                                >
                                    <NavLink
                                        to="/landingpage"
